...
import dev.newboxtest.JointCreditpayment;
import dev.utils.ScreenshotUtil;
import dev.utils.ExcelUtils;

import static org.testng.Assert.assertTrue;

public class JointCreditpaymentTestclass {

    private WebDriver driver;
    private Config config;
    private ScreenshotUtil screenshotUtil;
    private ExcelUtils excelUtil;
    private JointCreditpayment jointCreditpayment;
    ...
    public void setUp() {
        ...
        jointCreditpayment = new JointCreditpayment(config, screenshotUtil, excelUtil);
    }
    ...
    public void testLoginAsMaster() {
        try {
            ...
            jointCreditpayment.loginAsMaster(driver);
