...
import dev.newboxtest.JointNetBanking;
import dev.utils.ScreenshotUtil;
import dev.utils.ExcelUtils;

import static org.testng.Assert.assertTrue;

public class JointNetbankingTestclass {

    private WebDriver driver;
    private Config config;
    private ScreenshotUtil screenshotUtil;
    private ExcelUtils excelUtil;
    private JointNetBanking jointNetbanking;
    ...
    public void setUp() {
        ...
        jointNetbanking = new JointNetBanking(config, screenshotUtil, excelUtil);
    }
    ...
    public void testLoginAsMaster() {
        try {
            ...
            jointNetbanking.loginAsMaster(driver);
