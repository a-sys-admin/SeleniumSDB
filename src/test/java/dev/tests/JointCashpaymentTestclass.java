...
import dev.newboxtest.JointCashpayment;
import dev.utils.ScreenshotUtil;
import dev.utils.ExcelUtils;

import static org.testng.Assert.assertTrue;

public class JointCashpaymentTestclass {

    private WebDriver driver;
    private Config config;
    private ScreenshotUtil screenshotUtil;
    private ExcelUtils excelUtil;
    private JointCashpayment jointCashpayment;
    ...
    public void setUp() {
        ...
        jointCashpayment = new JointCashpayment(config, screenshotUtil, excelUtil);
    }
    ...
    public void testLoginAsMaster() {
        try {
            ...
            jointCashpayment.loginAsMaster(driver);
