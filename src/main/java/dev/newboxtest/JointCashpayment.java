...
public class JointCashpayment {
    ...
    public JointCashpayment(Config config, ScreenshotUtil screenshotUtil, ExcelUtils excelUtil) {
        this.config = config;
...
//                login(driver, config.getMasterUsername(), config.getPassword());
    ...
    private void performPaymentActions(WebDriver driver) throws Exception {
        try {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
...
//    }
   ...
   public static void main(String[] args) {
        ...
        try {
            ...
            JointCashpayment cashpayment = new JointCashpayment(config, screenshotUtil, excelUtil);
