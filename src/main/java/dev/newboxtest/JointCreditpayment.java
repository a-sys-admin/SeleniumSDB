...
public class JointCreditpayment {
    ...
    public JointCreditpayment(Config config, ScreenshotUtil screenshotUtil, ExcelUtils excelUtil) {
        this.config = config;
...
//    }
   ...
   public static void main(String[] args) {
        ...
        try {
            ...
            JointCreditpayment creditPayment = new JointCreditpayment(config, screenshotUtil, excelUtil);
