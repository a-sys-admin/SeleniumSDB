...
public class JointChequepayment {
    ...
    public JointChequepayment(Config config, ScreenshotUtil screenshotUtil, ExcelUtils excelUtil) {
        this.config = config;
...
//    }
   ...
   public static void main(String[] args) {
        ...
        try {
            ...
            JointChequepayment chequepayment = new JointChequepayment(config, screenshotUtil, excelUtil);
            chequepayment.loginAsMaster(driver);
